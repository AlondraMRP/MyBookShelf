...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <br>
            <h2 class="card-title text-center mb-4">My Bookshelf Yearly</h2>
            <hr>
            <div class="well">
                <form method="post" action="${pageContext.request.contextPath}/yearly">
            ...
            <c:if test="${requestScope.booksReadYearly != null}">
                <div class="row1-container">

                        <div class="box box-down cyan">
                            <h5>Total of Books Read in ${requestScope.selectedYear}</h5>
                            <p><c:out value="${requestScope.booksReadYearly}"/></p>
                        </div>

                        <div class="box orange">
                            <h5>Average of Books Rating in ${requestScope.selectedYear}</h5>
                            <p><c:out value="${requestScope.avgRatingYearly}"/></p>
                        </div>

                    <div class="box box-down blue">
                        <h5>Most Rated Books in ${requestScope.selectedYear} </h5>
                        <ol>
                            <c:forEach var="book" items="${requestScope.topRatingBooksYearly}">
                    ...
                    <div class="box red">
                        <h5>Best Read Authors in ${requestScope.selectedYear} </h5>
                        <ol>
                            <c:forEach var="author" items="${requestScope.topAuthorsYearly}">
                                <li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4>Most Read Genres in ${requestScope.selectedYear}</h4>
                    <div id="containerMonth" style="height: 450px;" ></div>
                    <script>
                        ...
                        function createChart(data) {
                            ...
                            chart.labels(true);
                            chart.container('containerMonth');
                            chart.draw();
                        }
                        let chartData = {
                        ...
                        <c:forEach var="genre" items="${requestScope.mostReadGenreYearly}">
            ...
            <div class="row" >
                <div class="col-sm-12">
                    <h4>Books Read Per Month in ${requestScope.selectedYear} </h4>
                    <div id="containerPerMonth" style="height: 500px;" ></div>
                    <script>
                        ...
                        function createChartYear(data) {
                            ...
                            yAxis.title("# of Books");
                            chart.labels(true);
                            chart.container('containerPerMonth');
                            chart.draw();
                        }
                        let chartDataYear = {
                            header: ["Month", "# of books"],
                            rows:[]
                        };
                        <c:forEach var="month" items="${requestScope.allBookReadPerMonth}">
                        chartDataYear.rows.push(["${month.key}", ${month.value}]);
                        </c:forEach>
